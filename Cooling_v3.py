...
X_train,X_test,y_train,y_test=train_test_split(train_all,Y2,test_size=0.3, random_state=123456)
 
models = []
names = []

 
models.append(('RandomForest', RandomForestRegressor(n_estimators=1000, random_state=123456)))
